...
print("Building complete master migration script...")
...
output_path = os.path.join("supabase", "schema_master_complete.sql")
with open(output_path, "w", encoding="utf-8") as f:
    f.write(schema_sql)

print(f"Master schema successfully written to {output_path} ({len(schema_sql)} characters).")
