...
- **[Distributed Inventory Client Portal PRD (Telesales & BI)](file:///c:/PROJECT/NoveXPS/DOCUMENTATION/CLIENT/distributed_inventory_merchant_portal_prd.md)**: Product requirements and architecture for merchant call-center order confirmation, landmark refinement, multi-DC inventory visibility, delivery success analytics, and COD remittances.
- **[Client Package On-Demand Dispatch App PRD (P2P)](file:///c:/PROJECT/NoveXPS/DOCUMENTATION/CLIENT/client_package_ondemand_app_prd.md)**: Product requirements for point-to-point on-demand rider dispatch, GIS nearest-rider discovery, dynamic distance pricing, and digital waybill POD.
- **[Client-Facing Ecosystem Architecture & Database Schema Blueprint](file:///c:/PROJECT/NoveXPS/DOCUMENTATION/ROADMAP_AND_ARCHITECTURE/client_facing_portals_and_ondemand_dispatch.md)**: Master roadmap, multi-tenant RBAC permissions, and PostgreSQL table schema for the client-facing expansion.
