                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Merchant: ${widget.client.companyName} | Settlement Account: ${widget.client.bankName.isNotEmpty ? widget.client.bankName : "No Bank Configured"} - ${widget.client.accountNumber}',
                        style: GoogleFonts.inter(
                          fontSize: 12,
