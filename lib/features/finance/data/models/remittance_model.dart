...
class RemittanceModel extends RemittanceEntity {
  const RemittanceModel({
    ...
    super.destinationBankName = 'NovaXpress Main Account (Zenith Bank)',
    super.destinationAccountNumber = '1012398412',
    super.destinationAccountName = 'NovaXpress Logistics Limited',
    super.notes,
  ...
  factory RemittanceModel.fromJson(Map<String, dynamic> json) {
    ...
    return RemittanceModel(
      ...
      destinationBankName: json['destination_bank_name']?.toString() ?? 'NovaXpress Main Account (Zenith Bank)',
      destinationAccountNumber: json['destination_account_number']?.toString() ?? '1012398412',
      destinationAccountName: json['destination_account_name']?.toString() ?? 'NovaXpress Logistics Limited',
